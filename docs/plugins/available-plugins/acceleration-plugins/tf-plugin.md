...
[Releases](https://github.com/nubificus/vaccel-plugin-tf/releases) page of the
[Tensorflow plugin repository](https://github.com/nubificus/vaccel-plugin-tf).
...
```sh
wget https://github.com/nubificus/vaccel-plugin-tf/releases/download/v0.7.0/vaccel-tf_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-tf_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-tf/releases/download/v0.7.0/vaccel-tf_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-tf_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
