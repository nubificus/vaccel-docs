...
[Releases](https://github.com/nubificus/vaccel-plugin-tvm/releases) page of the
[TVM plugin repository](https://github.com/nubificus/vaccel-plugin-tvm).
...
```sh
wget https://github.com/nubificus/vaccel-plugin-tvm/releases/download/v0.7.0/vaccel-tvm_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-tvm_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-tvm/releases/download/v0.7.0/vaccel-tvm_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-tvm_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
