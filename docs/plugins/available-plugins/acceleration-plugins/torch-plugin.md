...
[Releases](https://github.com/nubificus/vaccel-plugin-torch/releases) page of
the [Torch plugin repository](https://github.com/nubificus/vaccel-plugin-torch).
Releases include binaries for x86_64/aarch64 Ubuntu-based systems.
...
```sh
wget https://github.com/nubificus/vaccel-plugin-torch/releases/download/v0.7.0/vaccel-torch_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-torch_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-torch/releases/download/v0.7.0/vaccel-torch_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-torch_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
