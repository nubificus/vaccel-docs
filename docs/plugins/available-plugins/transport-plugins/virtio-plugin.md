...
[Releases](https://github.com/nubificus/vaccel-plugin-virtio/releases) page of
the
[VirtIO plugin repository](https://github.com/nubificus/vaccel-plugin-virtio).
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0-1_amd64.deb
sudo dpkg -i vaccel-virtio_0.7.0-1_amd64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0-1_arm64.deb
sudo dpkg -i vaccel-virtio_0.7.0-1_arm64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0-1_armhf.deb
sudo dpkg -i vaccel-virtio_0.7.0-1_armhf.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-virtio_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-virtio_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio_0.7.0_armhf.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-virtio_0.7.0_armhf.tar.gz --strip-components=2 -C /usr/local
```
...
[latest release](https://github.com/nubificus/vaccel-plugin-virtio/releases).
The provided artifacts contain an Ubuntu `rootfs.img` with the virtio-accel
module, VirtIO plugin and vAccel pre-installed. A Linux kernel image that can be
used to run a vAccel-enabled VM is also included.
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio-vm_0.7.0_amd64.tar.xz
# Replace 'vm-artifacts' with the desired artifact directory
tar xfv vaccel-virtio_0.7.0_amd64.tar.gz --strip-components=2 -C vm-artifacts
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-virtio/releases/download/v0.7.0/vaccel-virtio-vm_0.7.0_arm64.tar.gz
# Replace 'vm-artifacts' with the desired artifact directory
tar xfv vaccel-virtio_0.7.0_arm64.tar.gz --strip-components=2 -C vm-artifacts
```
