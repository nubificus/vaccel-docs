...
[Releases](https://github.com/nubificus/vaccel-plugin-rpc/releases) page of the
[RPC plugin repository](https://github.com/nubificus/vaccel-plugin-rpc).
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0-1_amd64.deb
sudo dpkg -i vaccel-rpc_0.7.0-1_amd64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0-1_arm64.deb
sudo dpkg -i vaccel-rpc_0.7.0-1_arm64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0-1_armhf.deb
sudo dpkg -i vaccel-rpc_0.7.0-1_armhf.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-plugin-rpc/releases/download/v0.7.0/vaccel-rpc_0.7.0_armhf.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc_0.7.0_armhf.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0-1_amd64.deb
sudo dpkg -i vaccel-rpc-agent_0.7.0-1_amd64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0-1_arm64.deb
sudo dpkg -i vaccel-rpc-agent_0.7.0-1_arm64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0-1_armhf.deb
sudo dpkg -i vaccel-rpc-agent_0.7.0-1_armhf.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_0.7.0_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_0.7.0_arm64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v0.7.0/vaccel-rpc-agent_0.7.0_armhf.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_0.7.0_armhf.tar.gz --strip-components=2 -C /usr/local
```
