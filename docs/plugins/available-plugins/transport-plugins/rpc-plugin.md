...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_amd64.deb
sudo dpkg -i vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_amd64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_arm64.deb
sudo dpkg -i vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_arm64.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_armhf.deb
sudo dpkg -i vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]-1_armhf.deb
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_amd64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_amd64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_arm64.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_arm64.tar.gz --strip-components=2 -C /usr/local
```
...
```sh
wget https://github.com/nubificus/vaccel-rust/releases/download/v[[ versions.vaccel ]]/vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_armhf.tar.gz
# Replace '/usr/local' below with the desired installation prefix
tar xfv vaccel-rpc-agent_[[ versions.plugins.rpc-agent ]]_armhf.tar.gz --strip-components=2 -C /usr/local
```
