...
install Tensorflow and Tensorflow Lite C/C++ API files for use with vAccel.
We assume that the required package dependencies are already installed.

## Install Bazel

The easiest way to install the required [Bazel](https://bazel.build/) version
is to use [Bazelisk](https://github.com/bazelbuild/bazelisk). You can grab the
