...
```sh
wget https://s3.nbfc.io/nbfc-assets/github/python-vaccel/main/x86_64/vaccel_python-0.0.1-cp310-cp310-linux_x86_64.whl
pip3 install vaccel_python-0.0.1-cp310-cp310-linux_x86_64.whl
```
...
```sh
wget https://s3.nbfc.io/nbfc-assets/github/python-vaccel/main/aarch64/vaccel_python-0.0.1-cp310-cp310-linux_aarch64.whl
pip3 install vaccel_python-0.0.1-cp310-cp310-linux_aarch64.whl
```
