# Running a vAccel application in a VM

## Overview

To run a vAccel application in a VM you have to use a suitable transport plugin.
...
The easiest way to run a vAccel application in a VM is to use the `RPC` plugin.
...
1. *Host:* The vAccel RPC agent + vAccel + an acceleration plugin, to handle
   the forwarded calls and perform the actual acceleration
2. *Guest:* vAccel + the `RPC` plugin, to forward the application calls

## Preparing the host

If you have not already installed vAccel, install it
[from binaries](binaries.md) or [from source](building.md). The rest of this
guide assumes vAccel libaries exist in the standard library search paths.
...
tested: [AWS Firecracker](#firecracker), [Cloud Hypervisor](#cloud-hypervisor)
or [QEMU](#qemu). You will need access to `/dev/kvm` so make sure that your
user is a member of the `kvm` group or launch the VM as the `root` user.
...
2025-03-30T18:14:06.866685961 [anonymous-instance:fc_vcpu 0] Received a VcpuEvent::Resume message with immediate_exit 
enabled. immediate_exit was disabled before proceeding                                                                
2025-03-30T18:14:06.866735354 [anonymous-instance:fc_vcpu 1] Received a VcpuEvent::Resume message with immediate_exit 
enabled. immediate_exit was disabled before proceeding                                                                
2025-03-30T18:14:06.866773907 [anonymous-instance:main] Successfully started microvm that was configured from one sing
le json                                                                                                               
[    0.000000] Linux version 6.1.132 (root@buildkitsandbox) (gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0, GNU ld (GNU Bi
nutils for Ubuntu) 2.42) #1 SMP PREEMPT_DYNAMIC Sun Mar 30 00:13:16 UTC 2025                                          
[    0.000000] Command line: console=ttyS0 reboot=k panic=1 pci=off loglevel=8 root=/dev/vda random.trust_cpu=on root=
/dev/vda rw virtio_mmio.device=4K@0xd0000000:5 virtio_mmio.device=4K@0xd0001000:6                                     
[...]
...
[    0.496211] systemd[1]: systemd 255.4-1ubuntu8.5 running in system mode (+PAM +AUDIT +SELINUX +APPARMOR +IMA +SMACK
 +SECCOMP +GCRYPT -GNUTLS +OPENSSL +ACL +BLKID +CURL +ELFUTILS +FIDO2 +IDN2 -IDN +IPTC +KMOD +LIBCRYPTSETUP +LIBFDISK 
+PCRE2 -PWQUALITY +P11KIT +QRENCODE +TPM2 +BZIP2 +LZ4 +XZ +ZLIB +ZSTD -BPF_FRAMEWORK -XKBCOMMON +UTMP +SYSVINIT defaul
t-hierarchy=unified)
...
[    0.000000] Linux version 6.1.132 (root@buildkitsandbox) (gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0, GNU ld (GNU Bi
nutils for Ubuntu) 2.42) #1 SMP PREEMPT_DYNAMIC Sun Mar 30 00:13:19 UTC 2025                                          
...
SELinux:  Could not open policy file <= /etc/selinux/targeted/policy/policy.33:  No such file or directory            
[    0.623287] systemd[1]: systemd 255.4-1ubuntu8.5 running in system mode (+PAM +AUDIT +SELINUX +APPARMOR +IMA +SMACK
 +SECCOMP +GCRYPT -GNUTLS +OPENSSL +ACL +BLKID +CURL +ELFUTILS +FIDO2 +IDN2 -IDN +IPTC +KMOD +LIBCRYPTSETUP +LIBFDISK 
+PCRE2 -PWQUALITY +P11KIT +QRENCODE +TPM2 +BZIP2 +LZ4 +XZ +ZLIB +ZSTD -BPF_FRAMEWORK -XKBCOMMON +UTMP +SYSVINIT defaul
t-hierarchy=unified)                                                                                                  
...
Current versions of QEMU provide a microVM machine with no PCI support, meant
to be used as a lightweight alternative to the default machine. This target aims
to provide and experience similar to Firecracker.
...
Before running a vAccel application in the guest, you need to first start the
...
2025.03.31-16:01:46.22 - <debug> Initializing vAccel
2025.03.31-16:01:46.22 - <info> vAccel 0.6.1-194-19056528
2025.03.31-16:01:46.22 - <debug> Config:
2025.03.31-16:01:46.22 - <debug>   plugins = libvaccel-noop.so
2025.03.31-16:01:46.22 - <debug>   log_level = debug
2025.03.31-16:01:46.22 - <debug>   log_file = (null)
2025.03.31-16:01:46.22 - <debug>   profiling_enabled = false
2025.03.31-16:01:46.22 - <debug>   version_ignore = false
2025.03.31-16:01:46.22 - <debug> Created top-level rundir: /run/user/1002/vaccel/FMO8qj
2025.03.31-16:01:46.22 - <info> Registered plugin noop 0.6.1-194-19056528
2025.03.31-16:01:46.22 - <debug> Registered op noop from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op blas_sgemm from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op image_classify from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op image_detect from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op image_segment from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op image_pose from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op image_depth from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op exec from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tf_session_load from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tf_session_run from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tf_session_delete from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op minmax from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op fpga_arraycopy from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op fpga_vectoradd from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op fpga_parallel from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op fpga_mmult from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op exec_with_resource from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op torch_jitload_forward from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op torch_sgemm from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op opencv from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tflite_session_load from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tflite_session_run from plugin noop
2025.03.31-16:01:46.22 - <debug> Registered op tflite_session_delete from plugin noop
2025.03.31-16:01:46.22 - <debug> Loaded plugin noop from libvaccel-noop.so
[2025-03-31T16:01:46Z INFO  ttrpc::sync::server] server listen started
[2025-03-31T16:01:46Z INFO  ttrpc::sync::server] server started
[2025-03-31T16:01:46Z INFO  vaccel_rpc_agent] vAccel RPC agent started
[2025-03-31T16:01:46Z INFO  vaccel_rpc_agent] Listening on 'vsock://2:2048', press Ctrl+C to exit
```
...
```sh
export VACCEL_RPC_ADDESS="vsock://2:2048"
```
where `2` is the well-known vSock address of the host and this address is
common for all the VMMs we have setup above.
...
2025.03.31-16:33:38.83 - <debug> Initializing vAccel
2025.03.31-16:33:38.83 - <info> vAccel 0.6.1-186-6ef2cd74
2025.03.31-16:33:38.83 - <debug> Config:
2025.03.31-16:33:38.84 - <debug>   plugins = libvaccel-rpc.so
2025.03.31-16:33:38.84 - <debug>   log_level = debug
2025.03.31-16:33:38.84 - <debug>   log_file = (null)
2025.03.31-16:33:38.84 - <debug>   profiling_enabled = false
2025.03.31-16:33:38.84 - <debug>   version_ignore = false
2025.03.31-16:33:38.84 - <debug> Created top-level rundir: /run/user/0/vaccel/Ti5GNL
2025.03.31-16:33:38.84 - <warn> Plugin may be incompatible with current vAccel version (built w/ 0.6.1-194-19056528, )
2025.03.31-16:33:38.84 - <info> Registered plugin rpc 0.1.0-36-bbffdae6
2025.03.31-16:33:38.85 - <debug> rpc is a VirtIO module
2025.03.31-16:33:38.85 - <debug> Registered op blas_sgemm from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op image_classify from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op image_detect from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op image_segment from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op image_depth from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op image_pose from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op tflite_session_load from plugin rpc
2025.03.31-16:33:38.85 - <debug> Registered op tflite_session_delete from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op tflite_session_run from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op minmax from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op fpga_arraycopy from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op fpga_mmult from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op fpga_vectoradd from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op fpga_parallel from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op exec from plugin rpc
2025.03.31-16:33:38.86 - <debug> Registered op exec_with_resource from plugin rpc
2025.03.31-16:33:38.87 - <debug> Registered op torch_jitload_forward from plugin rpc
2025.03.31-16:33:38.87 - <debug> Registered op opencv from plugin rpc
2025.03.31-16:33:38.87 - <debug> Registered op tf_session_load from plugin rpc
2025.03.31-16:33:38.87 - <debug> Registered op tf_session_delete from plugin rpc
2025.03.31-16:33:38.87 - <debug> Registered op tf_session_run from plugin rpc
2025.03.31-16:33:38.87 - <debug> Loaded plugin rpc from libvaccel-rpc.so
2025.03.31-16:33:38.87 - <debug> [rpc] Initializing new remote session
2025.03.31-16:33:38.87 - <debug> [rpc] Initialized remote session 1
2025.03.31-16:33:38.88 - <debug> New rundir for session 1: /run/user/0/vaccel/Ti5GNL/session.1
2025.03.31-16:33:38.88 - <debug> Initialized session 1 with remote (id: 1)
Initialized session with id: 1
2025.03.31-16:33:38.88 - <debug> session:1 Looking for plugin implementing VACCEL_OP_IMAGE_CLASSIFY
2025.03.31-16:33:38.88 - <debug> Returning func from hint plugin rpc 
2025.03.31-16:33:38.88 - <debug> Found implementation in rpc plugin
classification tags: This is a dummy classification tag!
2025.03.31-16:33:38.88 - <debug> [rpc] Releasing remote session 1
2025.03.31-16:33:38.89 - <debug> Released session 1
2025.03.31-16:33:38.89 - <debug> Cleaning up vAccel
2025.03.31-16:33:38.89 - <debug> Cleaning up sessions
2025.03.31-16:33:38.89 - <debug> Cleaning up resources
2025.03.31-16:33:38.89 - <debug> Cleaning up plugins
2025.03.31-16:33:38.89 - <debug> Unregistered plugin rpc
```

In the other terminal, where the vAccel RPC agent is running, you should also
see the corresponding host vAccel output:
```console
2025.03.31-16:33:38.95 - <debug> New rundir for session 1: /run/user/1002/vaccel/b8SIre/session.1
2025.03.31-16:33:38.95 - <debug> Initialized session 1
[2025-03-31T16:33:38Z INFO  vaccel_rpc_agent::session] Created session 1
[2025-03-31T16:33:38Z INFO  vaccel_rpc_agent::ops::genop] Genop session 1
2025.03.31-16:33:38.95 - <debug> session:1 Looking for plugin implementing VACCEL_OP_IMAGE_CLASSIFY
2025.03.31-16:33:38.95 - <debug> Returning func from hint plugin noop
2025.03.31-16:33:38.95 - <debug> Found implementation in noop plugin
2025.03.31-16:33:38.95 - <debug> [noop] Calling Image classification for session 1
2025.03.31-16:33:38.95 - <debug> [noop] Dumping arguments for Image classification:
2025.03.31-16:33:38.95 - <debug> [noop] model: (null)
2025.03.31-16:33:38.95 - <debug> [noop] len_img: 79281
2025.03.31-16:33:38.95 - <debug> [noop] len_out_text: 512
2025.03.31-16:33:38.95 - <debug> [noop] len_out_imgname: 512
2025.03.31-16:33:38.95 - <debug> [noop] will return a dummy result
2025.03.31-16:33:38.95 - <debug> [noop] will return a dummy result
2025.03.31-16:33:38.96 - <debug> Released session 1
[2025-03-31T16:33:38Z INFO  vaccel_rpc_agent::session] Destroyed session 1
```

If you compare the application output with the [native execution
case](build-run-app.md#running-a-vaccel-application) ignoring the vAccel log
messages, you will notice that it is identical:
```console
# classify /usr/local/share/vaccel/images/example.jpg 1
...
Initialized session with id: 1
